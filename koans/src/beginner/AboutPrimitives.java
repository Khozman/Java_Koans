...
public class AboutPrimitives {
    ...
    public void longsHaveALargerRangeThanInts() {
        Long blue = new Long(-9223372036854775808L);
        assertEquals(Long.MIN_VALUE, blue);
    ...
    public void shortsHaveASmallerRangeThanInts() {
        short s = (short) -32768;
        short t = (short) 32767;
        assertEquals(Short.MIN_VALUE, s);  // hint: You'll need an explicit cast
        assertEquals(Short.MAX_VALUE, t);
    }
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        byte s = (byte) -128;
        byte t = (byte) 127;
        assertEquals(Byte.MIN_VALUE, s);
        assertEquals(Byte.MAX_VALUE, t);
